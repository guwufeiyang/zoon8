			...
			<view class="header-bg">
				...
				<view class="fans-info">
					...
					<view class="info-r">
						...
						<button v-if="userInfo.bindedBand == bandId" class="btn-join" @click="contributeIntergral()">贡献积分<text class="icon-contribute-intergral"></text></button>
					</view>
				</view>
			</view>	
			...
			<view class="section">
				<ul class="message-list">
					<li class="message-item" 
						...
						v-for="(item, index) in comments" :key="index" @tap="selectFans(item)">
